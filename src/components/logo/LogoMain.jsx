  ...
  return (
    ...
    <>
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'end' }}>
        ...
        <img src={theme.palette.mode === 'dark' ? Logo : LogoDark} alt="icon logo" width="180" />
        <Chip label="v1.0.0" variant="light" color="primary" size="small" sx={{ mb: 1, borderRadius: 4 }}></Chip>
      </div>
    </>
  );
}
